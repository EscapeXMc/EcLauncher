 ...
 * **Smart Java Optimization:** Built-in automatic Java runtime detection ensures your game runs at peak FPS without manual tweaking.
**🎨 GOD-TIER VISUAL AESTHETICS**
 * **Glassmorphism UI:** A stunning, translucent interface that blends beautifully with your desktop background.
 * **Cyber-Neon Accents:** Crisp cyan, neon yellow, and electric red highlights give your setup an elite, high-tech energy.
 * **Tiny Caps Typography:** Clean, ultra-modern lettering throughout the UI for a sharp, premium aesthetic.
